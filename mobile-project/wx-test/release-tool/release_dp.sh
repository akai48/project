...
cp -f ./js/config/config-dp.js ./js/lib/jquery-app/config.js
#zepto 压缩
...
cp -f ./js/config/config-dp.js ./js/lib/zepto-app/config.js
...
mkdir ../../mbfun_web_release/wx-test-dp
...
cd ../releasetempfile
fis3 release -d ../../mbfun_web_release/wx-test-dp
rm -rf ../releasetempfile
rm -rf ../../mbfun_web_release/wx-test-dp/js/lib
rm -rf ../../mbfun_web_release/wx-test-dp/js/common
rm -rf ../../mbfun_web_release/wx-test-dp/js/config
rm -rf ../../mbfun_web_release/wx-test-dp/js/public
rm -rf ../../mbfun_web_release/wx-test-dp/css/temp
rm -rf ../../mbfun_web_release/wx-test-dp/css/public

cd ../../mbfun_web_release/wx-test-dp
filelist=$(ls *.html)
for file in $filelist
do
		echo $file
