...
cp -f ./js/config/config-api.js ./js/lib/jquery-app/config.js
#zepto 压缩
...
cp -f ./js/config/config-api.js ./js/lib/zepto-app/config.js
...
mkdir ../../mbfun_web_release/wx-test
...
cd ../releasetempfile
fis3 release -d ../../mbfun_web_release/wx-test
rm -rf ../releasetempfile
rm -rf ../../mbfun_web_release/wx-test/js/lib
rm -rf ../../mbfun_web_release/wx-test/js/common
rm -rf ../../mbfun_web_release/wx-test/js/config
rm -rf ../../mbfun_web_release/wx-test/js/public
rm -rf ../../mbfun_web_release/wx-test/css/temp
rm -rf ../../mbfun_web_release/wx-test/css/public

cd ../../mbfun_web_release/wx-test
filelist=$(ls *.html)
for file in $filelist
do
		echo $file
